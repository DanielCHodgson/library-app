...
export default class BookCard {
  ...
  readIconSvgString() {
    return this.#book.read ? this.#iconStrings.read : this.#iconStrings.unread;
  }
  ...
  #bindEvents() {
    ...
    this.#readIconContainer.addEventListener("click", (event) =>
      this.#handleReadIconClick(event)
    );
    this.#readIconContainer.addEventListener("click", () =>
  ...
  destroy() {
    ...
    this.#readIconContainer.removeEventListener("click", (event) =>
      this.#handleReadIconClick(event)
    );
    this.#readIconContainer.removeEventListener("click", () =>
      this.#handleReadIconMouseLeave()
    );
    this.deleteBtn = null;
